...
var Buy_Result = function (id,price,access) {
...
var Buy_Pay = function (id,type,price) {
    ...
    alert("微信支付准备");
    WechatPay(type,price,function () {
        Buy_Result(id,price,"wechat");
    },function () {
...
var InitSelectionMiner=function (MinerList,selection) {
    ...
    RuleInfo01.html("1.一年内，每日运动达标后（≥1万步），当日最多可挖"+MinerList[selection].daylimt+"枚FIT");
